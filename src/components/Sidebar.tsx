  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-sidebar-bg text-sidebar-text flex flex-col z-50">
      <div className="px-6 py-6 border-b border-white/10">
        ...
        <p className="text-xs text-sidebar-text/60 mt-1">Plan &amp; schedule your content</p>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-2">
          <div className="w-8 h-8 rounded-full bg-primary-light flex items-center justify-center text-sm font-bold text-white">
            U
          </div>
          <div>
            <p className="text-sm font-medium">User</p>
            <p className="text-xs text-sidebar-text/60">Free Plan</p>
          </div>
        </div>
      </div>
    </aside>
